...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Jan-2020 às 03:49
...
(1, 'Roberto', 1, 1, 1, '064.972.751-77', 17337, '123', 'r@g.com', '1027A', 1);
...
(3, 'Roberto Ajala da Costa Junior', '064.972.751-77', '123123', 1, 1, 'bebeto@g.com', '123123', 0);
...
CREATE TABLE `projeto` (
  ...
  `resumoProj` mediumtext DEFAULT NULL,
  `fotoProj` blob DEFAULT NULL,
  `idArea` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
